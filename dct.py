# -*- coding: utf-8 -*-
"""
Created on Mon Oct 24 12:12:41 2022
...
C = np.array([math.cos(math.pi / 16 * i) for i in range(8)])
S = np.array([1 / (4 * val) for val in C])
S[0] = 1 / (2 * math.sqrt(2))
A = np.array([
	None,
	C[4],
